...
namespace  Application.Services.BackEnd.Owner.Profile.Commands
{
    ...
    public class ChangePasswordOwnerProfileServices:IChangePasswordOwnerProfileServices
    {
        ...
        public ChangePasswordOwnerProfileServices(IIdealCrmDataBaseContext context, IHttpContextAccessor httpContext, UserManager<Domain.Entities.Users.User> userManager, SignInManager<Domain.Entities.Users.User> signInManager)
        {
            _context = context;
