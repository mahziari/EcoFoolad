...
{
    public partial class CrmConversationDefaultContextLang
    {
        public int CrmConversationDefaultContextLangId { get; set; }
        ...
        public virtual CrmConversationDefaultContext IdNavigation { get; set; }
