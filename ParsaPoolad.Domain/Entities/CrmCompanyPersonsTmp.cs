...
{
    public partial class CrmCompanyPersonsTmp
    {
        public CrmCompanyPersonsTmp()
        {
        ...
        public virtual CrmCompanyTmp PrsCompany { get; set; }
        ...
        public virtual Users PrsFirstRegisterUser { get; set; }
